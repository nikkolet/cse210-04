class Collection:
    ...
    The responsibility of a cast is to keep track of a collection of game objects. It has methods for 
    adding, removing and getting them by a group name.

    Attributes:
        _game_objects (dict): A dictionary of game objects { key: group_name, value: a list of game objects }
    """
